...
<body>
        ...
        <div class="container-fluid">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">اضافه
                        کردن</a>
    ...
    <div class="container mt-3 border border-primary">
        <h2>محصولات</h2><br>
        <p><a href="/products/create"><button type="button" class="btn btn-primary">اضافه کردن محصول</button></a></p>
                        ...
                        <td>
                            <form action="/products/delete/{{ $product->id }}" method="POST">
                               ...
                               @method('delete')
                                ...
                                <button type="submit" value="delete" class="btn btn-danger" onclick="return confirm('حذف شود ؟')">حذف</button></form>
                        </td>
                        <td><a href="/products/edit/{{ $product->id }}"><button type="button"
                                    class="btn btn-warning">ویرایش</button></a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
